...
define('ACCESS', true);
    ...
    if (IS_LOGIN) {
        ...
        if (null == $dir || null == $name || !is_file(processDirectory($dir.'/'.$name))) {
            ...
            if (null != $format && in_array($format, ['png', 'ico', 'jpg', 'jpeg', 'gif', 'bmp'])) {
            ...
            echo '<li><span class="bull">&bull;</span><strong>Định dạng</strong>: <span>'.(null == $format ? 'Không rõ' : $format).'</span></li>
