        ...
        if (isDatabaseVariable($databases)) {
            ...
            if ($conn != false) {
                ...
                if (empty($databases['db_name']) || $databases['db_name'] == null) {
                    ...
                    } elseif (isset($_GET['db_name']) && empty($_GET['db_name']) == false && mysqli_select_db($conn, $_GET['db_name'])) {
                        define('IS_CONNECT', true);
                        define('ERROR_SELECT_DB', false);
                        define('DATABASE_NAME', $_GET['db_name']);
                    }
                } elseif (empty($databases['db_name']) == false && $databases['db_name'] != null && mysqli_select_db($conn, $databases['db_name'])) {
                    define('IS_CONNECT', true);
                    define('ERROR_SELECT_DB', false);
