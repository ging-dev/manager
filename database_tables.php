    ...
    if (IS_LOGIN) {
        ...
        if (IS_CONNECT) {
            ...
            if (isset($_GET['action']) && trim($_GET['action']) == 'selected_table') {
                ...
                <ul class="list">
                    <li><img src="icon/database_table.png"/> <a href="database_tables.php?db_name=' . DATABASE_NAME . '">Danh sách bảng</a></li>
                </ul>';
            } else {
                ...
                if (is_object($query)) {
                    ...
                    if ($count == 0) {
                        echo '<ul class="list_database">
                            <li class="normal"><img src="icon/empty.png"/> <span class="empty">Không có bảng nào</span></li>
                        </ul>';
                    } else {
